...
export class SimulatorComponent implements OnInit {
  ...
  getCities(stateSelected:string){
    ...
    this.citiesAndStates.estados.forEach((state) => {

      if(stateSelected == state.nome){ 

        this.stateSelected = stateSelected

        console.log(`selectedState: ${this.stateSelected}, stateOnTheList: ${state.nome}`)
  ...
  getCity(cityName:string,state:string):void{
    ...
    this.cityService.getCity(cityName,state).subscribe((response)=>
    {
      ...
      console.log(this.cityFetched.city.id)
